package me.thecatisbest.LazyCode.commands;

import me.thecatisbest.LazyCode.Main;
import me.thecatisbest.LazyCode.commands.SubCommands.Reload;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (player.hasPermission(plugin.config.getString("Permission.Help-Command"))) {
                ...
                player.sendMessage(CC.color("&d&lLazyCode &f&oBy CloudOcean"));
                return true;
            }
        }
        return true;
